...
var addButton = document.querySelector(".todo__add__button");//first button
var incompleteTaskHolder = document.getElementById("todo__tasks");//ul of #incompleteTasks
var completedTasksHolder = document.getElementById("todo__tasks-completed");//completed-tasks
...
var createNewTaskElement = function (taskString) {
  ...
  label.className = 'task__text read';

  //Each elements, needs appending
  checkBox.type = "checkbox";
  checkBox.className = "task__is-completed";
  editInput.type = "text";
  editInput.className = "task__text edit";
...
var editTask = function () {
  ...
  var editInput = listItem.querySelector('.task__text.edit');
  var label = listItem.querySelector(".task__text.read");
...
var bindTaskEvents = function (taskListItem, checkBoxEventHandler) {
  ...
  var checkBox = taskListItem.querySelector(".task__is-completed");
